...
<html>
<head>
	<title>Polpa System - Pedidos dos Clientes</title>
	<meta charset="utf-8">
	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				...
				<?php
					$sql = "SELECT DISTINCT id_usuario FROM pedido ";
				...
				?>
				<form  action="selectPedidos.php" method="POST">
					<div class="form-group">
						<label>Cliente</label>
						<input type="hidden" readonly value="<?php echo $user?>" name="id_cliente" class="form-control">
						<input type="text" readonly value="<?php echo $nome['nome']?>"  class="form-control"><br>
						<button type="submit" name="btn_status" class="btn btn-dark">
							Verificar Pedidos deste Cliente
						</button><br><br>
					</div>
				</form>
				<?php
					...
					?>
					<input type="text" class="form-control" readonly placeholder="Nenhum pedido registrado !" >
					<br>
					<?php
				endif;
				?>
